...
JAZZMIN_SETTINGS = {
    ...
    "hide_models": ["oauth2_provider.Application", "oauth2_provider.grant", "oauth2_provider.IdToken"],

    "order_with_respect_to": ["auth", "app_account", "oauth2_provider"],
    ...
    "icons": {
        ...
        "app_account.VerifyEmail": "fa-solid fa-envelope-circle-check"
    },
