...
class BaseAdmin(BaseAdminFunction, admin.ModelAdmin):
...
class BaseTranslatableAdmin(BaseAdminFunction, TranslatableAdmin):
    base_readonly_fields = ["created_by", "created_at", "updated_by", "updated_at", "is_deleted", "deleted_by", "deleted_at", "slug"]
    base_fields = ["order", "is_active"]
...
class BaseStackedInlineAdmin(BaseAdminFunction, admin.StackedInline):
    base_readonly_fields = ["created_by", "created_at", "updated_by", "updated_at", "is_deleted", "deleted_by", "deleted_at", "slug"]
    base_fields = ["is_active"]


class BaseTabularInlineAdmin(admin.TabularInline, TranslatableTabularInline, BaseAdminFunction):
    base_readonly_fields = ["created_by", "created_at", "updated_by", "updated_at", "is_deleted", "deleted_by", "deleted_at", "slug"]
    base_fields = ["is_active"]
